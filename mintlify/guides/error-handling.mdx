...
<CodeGroup>
```json Error Response - Invalid Location for Update
{
  "success": false,
  "error": {
    "code": "NOT_FOUND",
...
```json Error Response - Conflict Error
{
  "success": false,
  "error": {
    "code": "CONFLICT",
...
```javascript JavaScript Location Update Handling
...
```python Python Location Update Handling
